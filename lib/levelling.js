...
const xpRange = (level, multiplier = global.multiplier || 1) => {
...
const findLevel = (xp, multiplier = global.multiplier || 1) => {
...
const canLevelUp = (level, xp, multiplier = global.multiplier || 1) => {
